...
public class DistanceService {
     ...
     */
    public static double getInMeters(double lat1, double lon1, double lat2, double lon2) {
        return getInMeters(haversinSortKey(lat1, lon1, lat2, lon2));
    }
    ...
    /**
     ...
     @return distance in meters.
     */
    public static double getInMeters(double sortKey) {
    ...
    /**
     ...
     @deprecated Use {@link #getInMeters(double, double, double, double) instead}
     */
    @Deprecated
    ...
    /**
     ...
     {@link #getInMeters(double, double, double, double)}, but it always compares the same.
     This can be converted into an actual distance with {@link #getInMeters(double)}, which
